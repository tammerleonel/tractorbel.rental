...
onAuthStateChanged(auth, mostrarConteudo);
...
function gerarGraficos(dados){
  ...
  graficos.push(new Chart(graficoEquipamento,{type:'bar',data:{labels:Object.keys(fatEquip),datasets:[{data:Object.values(fatEquip)}]}}));
  graficos.push(new Chart(graficoCliente,{type:'pie',data:{labels:Object.keys(fatCliente),datasets:[{data:Object.values(fatCliente)}]}}));
  graficos.push(new Chart(graficoManutencao,{type:'pie',data:{labels:Object.keys(manCliente),datasets:[{data:Object.values(manCliente)}]}}));
  graficos.push(new Chart(graficoDeficit,{type:'bar',data:{labels:Object.keys(deficitCliente),datasets:[{data:Object.values(deficitCliente)}]}}));
}